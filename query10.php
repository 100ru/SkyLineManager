...
<body>
    ...
    <!-- Table containing passenger details -->
    <table border="2" cellspacing="7">
        ...
        <tbody>
            ...
            // Query to fetch male passenger details associated with Jet agency
            $sql1 = "SELECT p.* FROM passenger p JOIN booking1 b ON p.p_id = b.p_id JOIN agency a ON b.a_id = a.a_id WHERE p.p_gender = 'Male' AND a.a_name = 'Jet'";
            ...
            if ($res = mysqli_query($conn, $sql1)) {
                ...
                echo "<tr><td colspan='4'>Error: Could not execute $sql1. " . mysqli_error($conn) . "</td></tr>"; 
            }
